...
//it is built in basis.cs
    ...
    protected string ConvertIdToCustomerName(object dealId)
    {
        return customers1.ConvertIdToCustomer(dealId + "");
    }
   
    protected string ConvertIdToCustomerEmployees(object dealId)
    {
        return employees1.ConvertIdToEmp(dealId + "");
    }
