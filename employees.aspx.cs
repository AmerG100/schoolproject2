...
//it is built in basis.cs
        ...
        {//all at first time
            ...
            ListBox1.DataValueField = "employeesID";
            ListBox1.DataSource = usingClasses.GetAllemployees();
            ListBox1.DataBind();
    ...
    protected void ListBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ds = usingClasses.EmployeesBy1name(ListBox1.Items[ListBox1.SelectedIndex].Value); 
